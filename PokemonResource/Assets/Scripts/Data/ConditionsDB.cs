...
public class ConditionsDB
{
    ...
    public static float GetStatusBonus(Condition condition)
    {
        ...
        else if(condition.Id == ConditionID.par|| condition.Id == ConditionID.psn || condition.Id == ConditionID.brn )// || condition.Id == ConditionID.psn || condition.Id = ConditionID.brn)
        {
            return 1.5f;
        }
